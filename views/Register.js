...
import {StyleSheet, View, Pressable, Text, ScrollView, Alert} from 'react-native';
...
const Register = () => {
  ...
  const handleRegister = async () => {
    try {
      ...
      switch (error) { // TODO: arreglar gestión de errores
        case 'InvalidEmailException':
          message = 'The email address is invalid.';
          break;
        case 'InvalidPasswordException':
          message = 'The password is invalid. It must be a string with at least six characters.';
          break;
...
<View
        ...
        {/* Código para repetir contraseña */}
